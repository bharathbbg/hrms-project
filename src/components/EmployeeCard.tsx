...
export default function EmployeeCard({ id, firstName, lastName, department, isActive }: EmployeeProps) {
  ...
  if (isDeleting) return <div className="p-6 bg-gray-100 rounded text-gray-400">Deleting...</div>;
